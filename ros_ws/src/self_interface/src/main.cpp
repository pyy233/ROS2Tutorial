...
#include "self_interface/msg/robot.hpp"
...
public:
    ...
    TopicPublisher01(std::string name) : Node(name)
    {
        ...
        command_publisher_ = this->create_publisher<self_interface::msg::Robot>("robot", 10);
...
private:
    ...
    {
        // 创建消息
        self_interface::msg::Robot message;
        message.name = "A";
    ...
    // 声明话题发布者指针
    rclcpp::Publisher<self_interface::msg::Robot>::SharedPtr command_publisher_;
};
